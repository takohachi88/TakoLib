...
namespace TakoLib.Urp.PostProcess
{
    ...
    public class MovieBasic : VolumeComponent, IPostProcessComponent
    {
        ...
        [Header("Blur")]
        public NoInterpClampedFloatParameter blurIntensity = new(1, 0, 1);
        public NoInterpVector2Parameter blurScale = new(Vector2.one);
        public NoInterpClampedIntParameter sampleCount = new(5, 2, 15);
        public NoInterpMinIntParameter downSamplingFactor = new(1, 1);
        public NoInterpClampedIntParameter blurDimention = new(3, 1, 6);

        [Header("Control")]
        public MovieControlModeParameter controlMode = new(MovieControlMode.None);
        public NoInterpVector2Parameter direction = new(new Vector2(1, 0));

        public NoInterpVector2Parameter center = new(new Vector2(0.5f, 0.5f));
        public NoInterpClampedFloatParameter smoothness = new(1, 0, 1);

        [Tooltip("R:intensity, GB: direction")]
        public TextureParameter controlTextureRgb = new(null);
        public NoInterpClampedFloatParameter controlIntensityR = new(0, 0, 1);
        public NoInterpVector2Parameter controlIntensityGb = new(new Vector2(0.5f, 0.5f));
        public NoInterpVector2Parameter tiling = new(Vector2.one);

        [Header("Chromatic Aberration")]
        public NoInterpClampedFloatParameter chromaticAberrationIntensity = new(0, 0, 1);

        [Header("Vignette")]
        public NoInterpClampedFloatParameter vignetteIntensity = new(0, 0, 1);
        public NoInterpClampedFloatParameter vignetteSmoothness = new(0, 0, 1);
        public NoInterpColorParameter vignetteColor = new(new Color(0, 0, 0));
        public BlendModeParameter vignetteBlendMode = new(BlendMode.Multiply);
