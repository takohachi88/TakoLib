...
namespace TakoLib.Urp
{
    ...
    {
        public static string PackagePath = "Packages/takolib.urp/";
        ...
        public static class ShaderId
        {
            ...
            public static readonly int PreviousBlitTexture = Shader.PropertyToID("_PreviousBlitTexture");
         
            public static readonly int FurParams = Shader.PropertyToID("_FurParams");
        }
